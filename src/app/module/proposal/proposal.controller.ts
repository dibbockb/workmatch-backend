...
const getFreelancerProposals = catchAsync(
...
const acceptCounterOffer = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await ProposalService.acceptCounterOffer(
		counterOfferId as string,
		user.userId,
	);
...
const rejectCounterOffer = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await ProposalService.rejectCounterOffer(
		counterOfferId as string,
		user.userId,
	);
