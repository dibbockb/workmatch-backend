...
export type ICreateProposalPayload = z.infer<
	typeof CreateProposalValidationSchema
>;
export type ICreateCounterOfferPayload = z.infer<
	typeof CreateCounterOfferValidationSchema
>;
